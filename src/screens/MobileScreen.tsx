    ...
    const sendVerificationCode = async () => {
        ...
        try {
            ...
            if (response.status) {
                ...
                // Save verification code in userData
                setUserData(prev => ({
                    ...prev,
                ...
                <View className="mt-12">
                    ...
                    <View className="flex-row items-center">
                        <TouchableOpacity
                            ...
                            className="flex-row items-center px-4 py-4 mr-2 bg-white border-2 rounded-xl dark:bg-slate-800 border-sky-300 dark:border-slate-700"
                        >
                            <CountryPicker
